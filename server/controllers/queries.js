...
const addRecipe = (userId, title, ingredients, method, imageUrl, tags) => {
  return db.query(
    `INSERT INTO recipes (userId, title, imageurl, ingredients, method, tags) VALUES ($1, $2, $3, $4, $5, $6)`,
    [userId, title, imageUrl, ingredients, method, tags],
  );
};
...
const getSingleRecipe = (recipeId) => {
  return db
    .query('SELECT * FROM recipes WHERE id = $1', [recipeId])
